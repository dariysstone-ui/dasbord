// api/handler.js — Express request handler (converted from Vercel serverless)
// Works with pre-aggregated JSON files (generated by aggregate_xlsx.py).
...
//
// Required env vars (.env file on server):
